...
export default function SidebarUser({ isOpen, onClose, onLogout }: SidebarProps) {
    ...
    // Menu disesuaikan dengan fitur Kasir
    const menus = [
        { label: "Input Tagihan", href: "/kasir/dashboard", icon: "💧" },
        { label: "Verifikasi Bayar", href: "/kasir/verifikasi", icon: "✅" },
    ]
                ...
                <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="text-[10px] text-slate-400 font-bold tracking-widest uppercase">Admin</span>
                        </div>
                    </div>
